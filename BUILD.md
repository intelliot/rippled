...
4. Configure CMake and pass the toolchain file generated by Conan, located at
...
-Dxrpld=true -Dtests=true
    ...
    ```
    cmake -Dxrpld=true -Dtests=true -DCMAKE_TOOLCHAIN_FILE:FILEPATH=build/generators/conan_toolchain.cmake -DCMAKE_BUILD_TYPE=Release ..
    ```
...
2. Remove the Conan cache:
   ...
   rm -rf ~/.conan/data
   ```
4. Re-run [conan install](#build-and-test) with appropriate options.
